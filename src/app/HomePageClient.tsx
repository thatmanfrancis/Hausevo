      ...
      <div className="w-full max-w-[1380px] bg-white rounded-[2.5rem] shadow-sm overflow-hidden relative flex flex-col min-h-[80vh]">
        ...
        <div className="px-8 md:px-14 pb-12 relative z-30">
          <div className="bg-white rounded-2xl border border-zinc-100 shadow-md flex flex-col md:flex-row items-stretch md:items-center p-2 gap-2 md:gap-0 max-w-3xl">
            <SearchField icon={<LocationIcon />} label="Location" divider>
              <select
                value={location}
            ...
            <SearchField icon={<HomeIcon />} label="Property Type" divider>
              <select
                value={propertyType}
            ...
            <SearchField icon={<PriceIcon />} label="Price Range">
              <select
                value={priceRange}
      ...
      {isModalOpen && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-extrabold mb-5 text-zinc-900">
              Watch Demo
            </h2>
            ...
            <p className="mt-5 text-zinc-400 text-sm leading-relaxed">
              See how Hausevo makes finding a verified Lagos home simple, fast,
              and agent-free.
            </p>
          </div>
        </div>
...
function SearchField({
  ...
  return (
    <div
      className={`flex-1 flex items-center px-5 py-3 ${divider ? "border-b md:border-b-0 md:border-r border-zinc-100" : ""}`}
    >
