        ...
        <div className="bg-zinc-900 rounded-2xl px-4 py-3 shadow-2xl shadow-black/40 flex flex-col gap-1 min-w-[180px]">
          {SECONDARY.map((item) => (
            <Link
              ...
              href={item.href}
              onClick={() => setTrayOpen(false)}
              className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-zinc-300 hover:text-white hover:bg-white/10 transition-colors"
            >
        ...
        <div className="flex items-center gap-1 bg-zinc-900 rounded-full px-3 py-2.5 shadow-2xl shadow-black/30">
          {PRIMARY.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="flex flex-col items-center gap-1 px-4 py-2 text-zinc-400 hover:text-white transition-colors rounded-full hover:bg-white/10"
            >
              {item.icon}
