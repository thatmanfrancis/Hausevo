...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Contact Hausevo — Support & General Enquiries",
    description:
      "Reach the Hausevo team for tenant support, landlord help, or legal enquiries.",
    ...
    <div className="max-w-3xl mx-auto py-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
        ...
        <ContactCard
          icon={<LocationIcon />}
          label="Office"
          value="Lekki Phase 1, Lagos state, Nigeria"
      ...
      <div className="bg-white rounded-2xl border border-zinc-200 p-6">
        ...
        <p className="text-sm text-zinc-500 mb-6">
          For faster support, use the in-app support ticket system if you have
          an account.
        </p>
        <ContactForm />
      </div>
...
function ContactCard({
  ...
  return (
    ...
    >
      <span className="text-zinc-400 group-hover:text-zinc-700 transition-colors mt-0.5 shrink-0">
        {icon}
      </span>
      <div>
        <p className="text-xs font-bold uppercase tracking-widest text-zinc-400 mb-0.5">
          {label}
        </p>
