      ...
      <div className="bg-white rounded-2xl border border-zinc-200 p-8 flex flex-col items-center text-center">
        ...
        <p className="text-sm text-zinc-400 mb-6 max-w-xs">
          {tier >= 2
            ...
            : "Your identity is verified. You can apply for properties and your ShackScore is visible to landlords."}
        </p>
...
export default function VerificationClient({ fullName, verificationTier, walletBalance, verificationBundlePaid }: Props) {
  const router = useRouter();

  // Step 0 = NIN (free), Step 1 = Upgrade (paid)
  ...
  // Step 1 state — upgradeNin pre-filled from step 0
    ...
    <div className="flex flex-col gap-5">
      ...
      {step === 0 && (
        <div className="bg-white rounded-2xl border border-zinc-200 p-6">
          ...
          <p className="text-xs font-bold uppercase tracking-widest text-zinc-400 mb-1">Step 1 of 2 — Free</p>
          ...
          <div className="mt-4 pt-4 border-t border-zinc-100 flex items-center justify-between">
            <p className="text-xs text-zinc-400">Already have Tier 0?</p>
            <button onClick={() => { setUpgradeNin(nin.trim()); setStep(1); }} className="text-xs font-bold text-zinc-700 hover:text-zinc-900 transition-colors">
      ...
      {/* ── Step 1: Upgrade to Tier 1 (₦1,500) ── */}
      {step === 1 && (
        <div className="bg-white rounded-2xl border border-zinc-200 p-6">
          ...
          <div className="flex items-start justify-between gap-4 mb-1">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-zinc-400 mb-1">Step 2 of 2 — ₦1,500</p>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            <div className="bg-white border-2 border-zinc-900 rounded-xl p-4">
              ...
              <ul className="space-y-1.5 text-xs text-zinc-700">
                ...
                <li className="flex items-center gap-1.5"><span className="text-emerald-500">✓</span> ShackScore visible</li>
              </ul>
            </div>
          </div>
          ...
          <form onSubmit={handleUpgrade} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              />
              <p className="text-xs text-zinc-400">Carried over from Step 1.</p>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {selfiePreview ? (
                ...
                <button
                  type="button"
                  onClick={() => fileRef.current?.click()}
                  className="flex flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-zinc-200 py-6 text-zinc-400 hover:border-zinc-400 hover:text-zinc-600 transition-colors"
                >
          ...
          <button
            onClick={() => setStep(0)}
            className="mt-4 flex items-center gap-1.5 text-xs font-semibold text-zinc-400 hover:text-zinc-700 transition-colors"
          >
