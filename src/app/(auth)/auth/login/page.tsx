    ...
    return (
      <AuthCard>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 rounded-full border border-zinc-200 bg-white py-3 text-sm font-bold text-zinc-700 hover:border-zinc-400 transition-colors"
        >
